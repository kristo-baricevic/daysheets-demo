<template>
    <div class="panel">
      ...
      <div class="help muted">
        Creating groups and adding team members will assign the group's default permissions and visibility
        settings as well as request the profile information for the group.
      </div>
      ...
      <div class="form">
        ...
        <div class="help muted">
          Permissions setting allows you to select the default access level you want to give to personnel joining
          this group. Visibility setting allows you to select the default information members of this group will see.
        </div>
        ...
        <div class="tpRow">
          <div class="tpLeft">
            <div class="tpTitle">
              Travel Profiles <span class="newPill">New</span>
            </div>
            <div class="help muted">
              Request information from every person who joins this group. You can update or change the requested
              information from specific individuals later.
            </div>
          </div>
